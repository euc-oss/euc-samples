...
| macOS | chnglocaluserpassword.sh | Script to change the password of the local enrolled user on macOS | [chnglocaluserpassword.sh](https://github.com/euc-oss/euc-samples/tree/main/UEM-Samples/Scripts/macOS/chnglocaluserpassword.sh) |
| macOS | create-admin-user.sh | Create local admin account if the current user is not the global admin | [create-admin-user.sh](https://github.com/euc-oss/euc-samples/tree/main/UEM-Samples/Scripts/macOS/create-admin-user.sh) |
...
| Windows | apply_secureboot_certificate_update.ps1 | Set Registry Key | [apply_secureboot_certificate_update.ps1](https://github.com/euc-oss/euc-samples/tree/main/UEM-Samples/Scripts/Windows/apply_secureboot_certificate_update.ps1) |
