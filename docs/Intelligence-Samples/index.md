...
| Workspace ONE UEM UUID Resolver | This Chrome extension resolves selected UUIDs on Omnissa Intelligence pages into readable entity details. Use the context menu to resolve, and view results via toasts and notifications. | [Link](https://github.com/euc-oss/euc-samples/tree/main/Intelligence-Samples/Workspace%20ONE%20UEM%20UUID%20Resolver) |
